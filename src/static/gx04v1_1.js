/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 20:38:0.57
*/
gx.evt.autoSkip = false;
gx.define('gx04v1_1', false, function () {
   this.ServerClass =  "gx04v1_1" ;
   this.PackageName =  "" ;
   ...
   this.e131s62_client=function()
   {
      this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e141s61_client=function()
   {
   ...
   this.Grid1Container = new gx.grid.grid(this, 2,"WbpLvl2",46,"Grid1","Grid1","Grid1Container",this.CmpContext,this.IsMasterPage,"gx04v1_1",[],false,1,false,true,10,true,false,false,"",0,"px","Novo registro",true,false,false,null,null,false,"",false,[1,1,1,1]);
   var Grid1Container = this.Grid1Container;
   Grid1Container.addBitmap("&Linkselection","vLINKSELECTION",47,0,"px",17,"px",null,"","","Image","");
   Grid1Container.addSingleLineEdit(1685,48,"CONTAPAGRECEMPRESAID","Empresa","","ContaPagRecEmpresaId","char",0,"px",10,10,"left",null,[],1685,"ContaPagRecEmpresaId",true,0,false,false,"Attribute",1,"");
   ...
   Grid1Container.addSingleLineEdit(1686,57,"CONTAPAGRECNUMERO","Número Conta","","ContaPagRecNumero","int",0,"px",8,8,"right",null,[],1686,"ContaPagRecNumero",false,0,false,false,"Attribute",1,"");
   ...
   GXValidFnc[48]={lvl:2,type:"char",len:10,dec:0,sign:false,pic:"@!",ro:1,isacc:0,grid:46,gxgrid:this.Grid1Container,fnc:null,isvalid:null,rgrid:[],fld:"CONTAPAGRECEMPRESAID",gxz:"Z1685ContaPagRecEmpresaId",gxold:"O1685ContaPagRecEmpresaId",gxvar:"A1685ContaPagRecEmpresaId",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){gx.O.A1685ContaPagRecEmpresaId=Value},v2z:function(Value){gx.O.Z1685ContaPagRecEmpresaId=Value},v2c:function(row){gx.fn.setGridControlValue("CONTAPAGRECEMPRESAID",row || gx.fn.currentGridRowImpl(46),gx.O.A1685ContaPagRecEmpresaId,0);if (typeof(this.dom_hdl) == 'function') this.dom_hdl.call(gx.O);},c2v:function(){gx.O.A1685ContaPagRecEmpresaId=this.val()},val:function(row){return gx.fn.getGridControlValue("CONTAPAGRECEMPRESAID",row || gx.fn.currentGridRowImpl(46))},nac:gx.falseFn};
   ...
   this.Events = {"e131s62_client": ["ENTER", true] ,"e141s61_client": ["CANCEL", true]};
   this.EvtParms["REFRESH"] = [[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cContaPagRecEmpresaId',fld:'vCCONTAPAGRECEMPRESAID'},{av:'AV7cContaPagRecFatura',fld:'vCCONTAPAGRECFATURA'},{av:'AV8cContaPagRecDocumento',fld:'vCCONTAPAGRECDOCUMENTO'},{av:'AV9cContaPagRecSeqDocume',fld:'vCCONTAPAGRECSEQDOCUME'},{av:'AV10cContaPagRecSituacao',fld:'vCCONTAPAGRECSITUACAO'},{av:'AV11cContaPagRecPagRec',fld:'vCCONTAPAGRECPAGREC'},{av:'AV13pContaPagRecNumero',fld:'vPCONTAPAGRECNUMERO',hsh:true}],[]];
   this.EvtParms["LOAD"] = [[],[{av:'AV5LinkSelection',fld:'vLINKSELECTION'}]];
   this.EvtParms["ENTER"] = [[{av:'A1685ContaPagRecEmpresaId',fld:'CONTAPAGRECEMPRESAID'}],[{av:'AV12pContaPagRecEmpresaId',fld:'vPCONTAPAGRECEMPRESAID'}]];
   ...
   Grid1Container.addRefreshingVar({rfrVar:"AV13pContaPagRecNumero"});
   this.InitStandaloneVars( );
});
gx.setParentObj(new gx04v1_1());
