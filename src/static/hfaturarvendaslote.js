/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 20:20:45.82
*/
gx.evt.autoSkip = false;
gx.define('hfaturarvendaslote', false, function () {
   this.ServerClass =  "hfaturarvendaslote" ;
   this.PackageName =  "" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV46ProdutoIdOri=gx.fn.getIntegerValue("vPRODUTOIDORI",'.') ;
      this.AV45LoteProdutoCombinacaoOri=gx.fn.getControlValue("vLOTEPRODUTOCOMBINACAOORI") ;
      this.AV43FaturamentoNumero=gx.fn.getIntegerValue("vFATURAMENTONUMERO",'.') ;
      this.AV44SaidaItemValorUnitario=gx.fn.getDecimalValue("vSAIDAITEMVALORUNITARIO",'.',',') ;
      this.AV19FilialEmpresaId=gx.fn.getControlValue("vFILIALEMPRESAID") ;
      this.AV38SaidaItemQuantidade=gx.fn.getDecimalValue("vSAIDAITEMQUANTIDADE",'.',',') ;
   ...
   this.Grid1Container = new gx.grid.grid(this, 2,"WbpLvl2",22,"Grid1","Grid1","Grid1Container",this.CmpContext,this.IsMasterPage,"hfaturarvendaslote",[],false,1,false,true,0,false,false,false,"",0,"px","Novo registro",false,false,false,null,null,false,"",false,[1,1,1,1]);
   ...
   GXValidFnc[28]={lvl:2,type:"char",len:20,dec:0,sign:false,ro:0,isacc:0,grid:22,gxgrid:this.Grid1Container,fnc:this.Validv_Loteprodutocombinacao,isvalid:null,rgrid:[],fld:"vLOTEPRODUTOCOMBINACAO",gxz:"ZV23LoteProdutoCombinacao",gxold:"OV23LoteProdutoCombinacao",gxvar:"AV23LoteProdutoCombinacao",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){gx.O.AV23LoteProdutoCombinacao=Value},v2z:function(Value){gx.O.ZV23LoteProdutoCombinacao=Value},v2c:function(row){gx.fn.setGridControlValue("vLOTEPRODUTOCOMBINACAO",row || gx.fn.currentGridRowImpl(22),gx.O.AV23LoteProdutoCombinacao,0)},c2v:function(){gx.O.AV23LoteProdutoCombinacao=this.val()},val:function(row){return gx.fn.getGridControlValue("vLOTEPRODUTOCOMBINACAO",row || gx.fn.currentGridRowImpl(22))},nac:gx.falseFn};
   ...
   this.AV46ProdutoIdOri = 0 ;
   this.AV45LoteProdutoCombinacaoOri = "" ;
   this.AV43FaturamentoNumero = 0 ;
   this.AV44SaidaItemValorUnitario = 0 ;
   this.AV19FilialEmpresaId = "" ;
   this.AV38SaidaItemQuantidade = 0 ;
   ...
   this.EvtParms["'RETORNO'"] = [[{av:'A11767FaturamentoProdutoEmpId',fld:'FATURAMENTOPRODUTOEMPID'},{av:'AV26ProdutoEmpresaId',fld:'vPRODUTOEMPRESAID',hsh:true},{av:'A11768FaturamentoProdutoId',fld:'FATURAMENTOPRODUTOID'},{av:'AV46ProdutoIdOri',fld:'vPRODUTOIDORI',hsh:true},{av:'A11769FaturamentoCombinacao',fld:'FATURAMENTOCOMBINACAO'},{av:'AV45LoteProdutoCombinacaoOri',fld:'vLOTEPRODUTOCOMBINACAOORI',hsh:true},{av:'A11771FaturamentoValorUnitario',fld:'FATURAMENTOVALORUNITARIO'},{av:'AV44SaidaItemValorUnitario',fld:'vSAIDAITEMVALORUNITARIO',hsh:true},{av:'A11770FaturamentoNumero',fld:'FATURAMENTONUMERO'},{av:'AV43FaturamentoNumero',fld:'vFATURAMENTONUMERO',hsh:true},{av:'A11772FaturamentoSubstituicaoEmpId',fld:'FATURAMENTOSUBSTITUICAOEMPID'},{av:'A11773FaturamentoSubstituicaoId',fld:'FATURAMENTOSUBSTITUICAOID'},{av:'AV27ProdutoId',fld:'vPRODUTOID',hsh:true},{av:'A11774FaturamentoSubstituicaoCombina',fld:'FATURAMENTOSUBSTITUICAOCOMBINA'},{av:'AV23LoteProdutoCombinacao',fld:'vLOTEPRODUTOCOMBINACAO'},{av:'A11785FaturamentoSubstituicaoQuantid',fld:'FATURAMENTOSUBSTITUICAOQUANTID'},{av:'AV37hasErro',fld:'vHASERRO'},{av:'A1228FilialEmpresaId',fld:'FILIALEMPRESAID'},{av:'AV19FilialEmpresaId',fld:'vFILIALEMPRESAID',hsh:true},{av:'A1156FilialId',fld:'FILIALID'},{av:'AV20FilialId',fld:'vFILIALID',hsh:true},{av:'A2964ProdutoEmpresaId',fld:'PRODUTOEMPRESAID'},{av:'A2965ProdutoId',fld:'PRODUTOID'},{av:'A3624LoteProdutoCombinacao',fld:'LOTEPRODUTOCOMBINACAO'},{av:'AV38SaidaItemQuantidade',fld:'vSAIDAITEMQUANTIDADE',hsh:true},{av:'AV32QtdeLote',fld:'vQTDELOTE'},{av:'A3645LoteProdutoQtdeAtual',fld:'LOTEPRODUTOQTDEATUAL'},{av:'AV42hasLoteProd',fld:'vHASLOTEPROD'},{av:'AV41hasLoteOutProd',fld:'vHASLOTEOUTPROD'},{av:'AV40hasLoteFat',fld:'vHASLOTEFAT'},{av:'A2921AtributoEsquemaCodigo',fld:'ATRIBUTOESQUEMACODIGO'},{av:'A2915EsquemaCodigo',fld:'ESQUEMACODIGO'},{av:'AV18EsquemaCodigo',fld:'vESQUEMACODIGO'},{av:'A2917AtributoEsquemaSnCadastrado',fld:'ATRIBUTOESQUEMASNCADASTRADO'},{av:'A2941ValorAtributoCodigo',fld:'VALORATRIBUTOCODIGO'},{av:'A2938ValorAtributoDescricao',fld:'VALORATRIBUTODESCRICAO'},{av:'A2916AtributoEsquemaDescricao',fld:'ATRIBUTOESQUEMADESCRICAO'}],[{av:'AV32QtdeLote',fld:'vQTDELOTE'},{av:'AV42hasLoteProd',fld:'vHASLOTEPROD'},{av:'AV40hasLoteFat',fld:'vHASLOTEFAT'},{av:'AV33SdtAdvertencia',fld:'vSDTADVERTENCIA'},{av:'AV53GXV1',fld:'vGXV1'},{av:'AV34SdtAdvertenciaItem',fld:'vSDTADVERTENCIAITEM'},{av:'AV28OutLoteProdutoCombinacao',fld:'vOUTLOTEPRODUTOCOMBINACAO'},{av:'AV29SnLoteEscolhido',fld:'vSNLOTEESCOLHIDO'},{av:'AV37hasErro',fld:'vHASERRO'},{av:'AV22hasReg',fld:'vHASREG'},{av:'AV23LoteProdutoCombinacao',fld:'vLOTEPRODUTOCOMBINACAO'},{av:'AV6LoteProdutoQtdeAtual',fld:'vLOTEPRODUTOQTDEATUAL'},{av:'AV13Edit1',fld:'vEDIT1'},{av:'AV14Edit2',fld:'vEDIT2'},{av:'AV15Edit3',fld:'vEDIT3'},{av:'AV16Edit4',fld:'vEDIT4'},{av:'AV17Edit5',fld:'vEDIT5'},{av:'gx.fn.getCtrlProperty("vEDIT1","Visible")',ctrl:'vEDIT1',prop:'Visible'},{av:'gx.fn.getCtrlProperty("vEDIT2","Visible")',ctrl:'vEDIT2',prop:'Visible'},{av:'gx.fn.getCtrlProperty("vEDIT3","Visible")',ctrl:'vEDIT3',prop:'Visible'},{av:'gx.fn.getCtrlProperty("vEDIT4","Visible")',ctrl:'vEDIT4',prop:'Visible'},{av:'gx.fn.getCtrlProperty("vEDIT5","Visible")',ctrl:'vEDIT5',prop:'Visible'},{av:'AV7Count',fld:'vCOUNT'},{av:'gx.fn.getCtrlProperty("vEDIT1","Title")',ctrl:'vEDIT1',prop:'Title'},{av:'gx.fn.getCtrlProperty("vEDIT2","Title")',ctrl:'vEDIT2',prop:'Title'},{av:'gx.fn.getCtrlProperty("vEDIT3","Title")',ctrl:'vEDIT3',prop:'Title'},{av:'gx.fn.getCtrlProperty("vEDIT4","Title")',ctrl:'vEDIT4',prop:'Title'},{av:'gx.fn.getCtrlProperty("vEDIT5","Title")',ctrl:'vEDIT5',prop:'Title'}]];
   this.setVCMap("AV26ProdutoEmpresaId", "vPRODUTOEMPRESAID", 0, "char");
   this.setVCMap("AV46ProdutoIdOri", "vPRODUTOIDORI", 0, "int");
   this.setVCMap("AV45LoteProdutoCombinacaoOri", "vLOTEPRODUTOCOMBINACAOORI", 0, "char");
   this.setVCMap("AV43FaturamentoNumero", "vFATURAMENTONUMERO", 0, "int");
   this.setVCMap("AV44SaidaItemValorUnitario", "vSAIDAITEMVALORUNITARIO", 0, "decimal");
   this.setVCMap("AV19FilialEmpresaId", "vFILIALEMPRESAID", 0, "char");
   this.setVCMap("AV38SaidaItemQuantidade", "vSAIDAITEMQUANTIDADE", 0, "decimal");
...
gx.setParentObj(new hfaturarvendaslote());
