/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 18:50:2.46
*/
gx.evt.autoSkip = false;
gx.define('hconsultadepto', false, function () {
   this.ServerClass =  "hconsultadepto" ;
   this.PackageName =  "" ;
   ...
   this.e181h22_client=function()
   {
      this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e111h22_client=function()
   {
      this.executeServerEvent("'GXM_FIRST'", true, null, false, false);
   };
   this.e121h22_client=function()
   {
      this.executeServerEvent("'GXM_PREVIOUS'", true, null, false, false);
   };
   this.e131h22_client=function()
   {
      this.executeServerEvent("'GXM_NEXT'", true, null, false, false);
   };
   this.e141h22_client=function()
   {
      this.executeServerEvent("'GXM_LAST'", true, null, false, false);
   };
   this.e151h22_client=function()
   {
      this.executeServerEvent("'PROCURAR'", false, null, false, false);
   };
   this.e161h22_client=function()
   {
      this.executeServerEvent("'NOVO'", true, null, false, false);
   };
   this.e201h22_client=function()
   {
      this.executeServerEvent("'ALTERAR'", true, arguments[0], false, false);
   };
   this.e221h22_client=function()
   {
      this.executeServerEvent("'ATUALIZAPAGINA'", true, arguments[0], false, false);
   };
   this.e231h21_client=function()
   {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",28,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"hconsultadepto",[],false,1,true,true,0,false,false,false,"",0,"px","Novo registro",true,false,false,null,null,false,"",false,[1,1,1,1]);
   var GridContainer = this.GridContainer;
   GridContainer.addSingleLineEdit(3488,29,"DEPTOCOMPRASCODIGO","","","DeptoComprasCodigo","svchar",0,"px",15,15,"left",null,[],3488,"DeptoComprasCodigo",true,0,false,false,"SemQuebraGrid",1,"");
   ...
   GridContainer.addSingleLineEdit("Nomeresponsavel",31,"vNOMERESPONSAVEL","Nome Responsável","","NomeResponsavel","svchar",0,"px",40,40,"left",null,[],"Nomeresponsavel","NomeResponsavel",true,0,false,false,"SemQuebraGrid",1,"");
   ...
   GridContainer.addBitmap("&Bmpalt","vBMPALT",33,0,"px",17,"px","e201h22_client","","Alterar","Image","GridColumnImage");
   ...
   this.Events = {"e181h22_client": ["ENTER", true] ,"e111h22_client": ["'GXM_FIRST'", true] ,"e121h22_client": ["'GXM_PREVIOUS'", true] ,"e131h22_client": ["'GXM_NEXT'", true] ,"e141h22_client": ["'GXM_LAST'", true] ,"e151h22_client": ["'PROCURAR'", true] ,"e161h22_client": ["'NOVO'", true] ,"e201h22_client": ["'ALTERAR'", true] ,"e221h22_client": ["'ATUALIZAPAGINA'", true] ,"e231h21_client": ["CANCEL", true]};
...
gx.setParentObj(new hconsultadepto());
