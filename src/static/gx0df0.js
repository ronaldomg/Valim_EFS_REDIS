/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 20:34:34.38
*/
gx.evt.autoSkip = false;
gx.define('gx0df0', false, function () {
   this.ServerClass =  "gx0df0" ;
   this.PackageName =  "" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV17pLancamentoCaixaId=gx.fn.getIntegerValue("vPLANCAMENTOCAIXAID",'.') ;
   };
   this.e131pc2_client=function()
   {
      this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e141pc1_client=function()
   {
   ...
   this.Grid1Container = new gx.grid.grid(this, 2,"WbpLvl2",51,"Grid1","Grid1","Grid1Container",this.CmpContext,this.IsMasterPage,"gx0df0",[],false,1,false,true,10,true,false,false,"",0,"px","Novo registro",true,false,false,null,null,false,"",false,[1,1,1,1]);
   ...
   Grid1Container.addSingleLineEdit(3632,57,"LANCAMENTOCAIXAID","Lançamento do Caixa","","LancamentoCaixaId","int",0,"px",6,6,"right",null,[],3632,"LancamentoCaixaId",true,0,false,false,"Attribute",1,"");
   ...
   GXValidFnc[32]={fld:"TEXTBLOCKLANCAMENTOCAIXAID", format:0,grid:0};
   GXValidFnc[34]={lvl:0,type:"int",len:6,dec:0,sign:false,pic:"ZZZZZ9",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[this.Grid1Container],fld:"vCLANCAMENTOCAIXAID",gxz:"ZV10cLancamentoCaixaId",gxold:"OV10cLancamentoCaixaId",gxvar:"AV10cLancamentoCaixaId",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",v2v:function(Value){gx.O.AV10cLancamentoCaixaId=gx.num.intval(Value)},v2z:function(Value){gx.O.ZV10cLancamentoCaixaId=gx.num.intval(Value)},v2c:function(){gx.fn.setControlValue("vCLANCAMENTOCAIXAID",gx.O.AV10cLancamentoCaixaId,0)},c2v:function(){gx.O.AV10cLancamentoCaixaId=gx.num.intval(this.val())},val:function(){return gx.fn.getIntegerValue("vCLANCAMENTOCAIXAID",'.')},nac:gx.falseFn};
   GXValidFnc[37]={fld:"TEXTBLOCKLANCAMENTOCAIXADATA", format:0,grid:0};
   GXValidFnc[39]={lvl:0,type:"date",len:10,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[this.Grid1Container],fld:"vCLANCAMENTOCAIXADATA",gxz:"ZV11cLancamentoCaixaData",gxold:"OV11cLancamentoCaixaData",gxvar:"AV11cLancamentoCaixaData",dp:{f:0,st:false,wn:false,mf:false,pic:"99/99/9999",dec:0},ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",v2v:function(Value){gx.O.AV11cLancamentoCaixaData=gx.fn.toDatetimeValue(Value)},v2z:function(Value){gx.O.ZV11cLancamentoCaixaData=gx.fn.toDatetimeValue(Value)},v2c:function(){gx.fn.setControlValue("vCLANCAMENTOCAIXADATA",gx.O.AV11cLancamentoCaixaData,0)},c2v:function(){gx.O.AV11cLancamentoCaixaData=gx.fn.toDatetimeValue(this.val())},val:function(){return gx.fn.getControlValue("vCLANCAMENTOCAIXADATA")},nac:gx.falseFn};
   GXValidFnc[42]={fld:"TEXTBLOCKLANCAMENTOCAIXAHORA", format:0,grid:0};
   GXValidFnc[44]={lvl:0,type:"char",len:5,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[this.Grid1Container],fld:"vCLANCAMENTOCAIXAHORA",gxz:"ZV12cLancamentoCaixaHora",gxold:"OV12cLancamentoCaixaHora",gxvar:"AV12cLancamentoCaixaHora",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",v2v:function(Value){gx.O.AV12cLancamentoCaixaHora=Value},v2z:function(Value){gx.O.ZV12cLancamentoCaixaHora=Value},v2c:function(){gx.fn.setControlValue("vCLANCAMENTOCAIXAHORA",gx.O.AV12cLancamentoCaixaHora,0)},c2v:function(){gx.O.AV12cLancamentoCaixaHora=this.val()},val:function(){return gx.fn.getControlValue("vCLANCAMENTOCAIXAHORA")},nac:gx.falseFn};
   ...
   GXValidFnc[57]={lvl:2,type:"int",len:6,dec:0,sign:false,pic:"ZZZZZ9",ro:1,isacc:0,grid:51,gxgrid:this.Grid1Container,fnc:null,isvalid:null,rgrid:[],fld:"LANCAMENTOCAIXAID",gxz:"Z3632LancamentoCaixaId",gxold:"O3632LancamentoCaixaId",gxvar:"A3632LancamentoCaixaId",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.A3632LancamentoCaixaId=gx.num.intval(Value)},v2z:function(Value){gx.O.Z3632LancamentoCaixaId=gx.num.intval(Value)},v2c:function(row){gx.fn.setGridControlValue("LANCAMENTOCAIXAID",row || gx.fn.currentGridRowImpl(51),gx.O.A3632LancamentoCaixaId,0)},c2v:function(){gx.O.A3632LancamentoCaixaId=gx.num.intval(this.val())},val:function(row){return gx.fn.getGridIntegerValue("LANCAMENTOCAIXAID",row || gx.fn.currentGridRowImpl(51),'.')},nac:gx.falseFn};
   ...
   this.AV10cLancamentoCaixaId = 0 ;
   this.ZV10cLancamentoCaixaId = 0 ;
   this.OV10cLancamentoCaixaId = 0 ;
   this.AV11cLancamentoCaixaData = gx.date.nullDate() ;
   this.ZV11cLancamentoCaixaData = gx.date.nullDate() ;
   this.OV11cLancamentoCaixaData = gx.date.nullDate() ;
   this.AV12cLancamentoCaixaHora = "" ;
   this.ZV12cLancamentoCaixaHora = "" ;
   this.OV12cLancamentoCaixaHora = "" ;
   ...
   this.setVCMap("AV17pLancamentoCaixaId", "vPLANCAMENTOCAIXAID", 0, "int");
