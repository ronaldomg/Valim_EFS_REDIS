/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 14:0:28.38
*/
gx.evt.autoSkip = false;
gx.define('hobslancamentofiscal', false, function () {
   this.ServerClass =  "hobslancamentofiscal" ;
   this.PackageName =  "" ;
   ...
   this.e11vy2_client=function()
   {
      this.executeServerEvent("'ANTERIOR'", true, null, false, false);
   };
   this.e12vy2_client=function()
   {
      this.executeServerEvent("'PROXIMO'", true, null, false, false);
   };
   this.e17vy2_client=function()
   {
      this.executeServerEvent("VPAGINA.CLICK", true, null, false, true);
   };
   this.e13vy2_client=function()
   {
      this.executeServerEvent("'NOVO'", true, null, false, false);
   };
   this.e14vy2_client=function()
   {
      this.executeServerEvent("'FECHAR'", false, null, false, false);
   };
   this.e15vy2_client=function()
   {
      this.executeServerEvent("'IMPRIMIR'", true, null, false, false);
   };
   this.e16vy2_client=function()
   {
      this.executeServerEvent("'PROCURAR'", false, null, false, false);
   };
   this.e20vy2_client=function()
   {
      this.executeServerEvent("'ALTERAR'", true, arguments[0], false, false);
   };
   this.e21vy2_client=function()
   {
      this.executeServerEvent("'EXCLUIR'", true, arguments[0], false, false);
   };
   this.e22vy2_client=function()
   {
      this.executeServerEvent("'CONSULTAR'", true, arguments[0], false, false);
   };
   this.e23vy2_client=function()
   {
      this.executeServerEvent("'ATUALIZAPAGINA'", true, arguments[0], false, false);
   };
   this.e25vy2_client=function()
   {
      this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e26vy2_client=function()
   {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",48,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"hobslancamentofiscal",[],false,1,false,true,0,false,false,false,"",0,"px","Novo registro",true,false,false,null,null,false,"",false,[1,1,1,1]);
   var GridContainer = this.GridContainer;
   GridContainer.addSingleLineEdit(5488,49,"OBSLANCAMENTOFISCALCODIGO","","","ObsLancamentoFiscalCodigo","int",0,"px",4,4,"right",null,[],5488,"ObsLancamentoFiscalCodigo",true,0,false,false,"SemQuebraGrid",1,"");
   GridContainer.addSingleLineEdit(5484,50,"OBSLANCAMENTOFISCALDESCRICAO","","","ObsLancamentoFiscalDescricao","svchar",0,"px",70,70,"left",null,[],5484,"ObsLancamentoFiscalDescricao",true,0,false,false,"SemQuebraGrid",1,"");
   GridContainer.addBitmap("&Bmpalt","vBMPALT",51,0,"px",17,"px","e20vy2_client","","Alterar","Image","GridColumnImage");
   GridContainer.addBitmap("&Bmpexc","vBMPEXC",52,0,"px",17,"px","e21vy2_client","","Excluir","Image","GridColumnImage");
   GridContainer.addBitmap("&Bmpcon","vBMPCON",53,0,"px",17,"px","e22vy2_client","","Consultar","Image","GridColumnImage");
   this.setGrid(GridContainer);
   GXValidFnc[2]={fld:"TABLE2",grid:0};
   GXValidFnc[5]={fld:"TABLE8",grid:0};
   GXValidFnc[8]={fld:"TABLE9",grid:0};
   GXValidFnc[11]={fld:"TXTTITAPL1", format:0,grid:0};
   GXValidFnc[13]={lvl:0,type:"int",len:4,dec:0,sign:false,pic:"ZZZ9",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[this.GridContainer],fld:"vOBSLANCAMENTOFISCALCODIGO",gxz:"ZV27ObsLancamentoFiscalCodigo",gxold:"OV27ObsLancamentoFiscalCodigo",gxvar:"AV27ObsLancamentoFiscalCodigo",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",v2v:function(Value){gx.O.AV27ObsLancamentoFiscalCodigo=gx.num.intval(Value)},v2z:function(Value){gx.O.ZV27ObsLancamentoFiscalCodigo=gx.num.intval(Value)},v2c:function(){gx.fn.setControlValue("vOBSLANCAMENTOFISCALCODIGO",gx.O.AV27ObsLancamentoFiscalCodigo,0)},c2v:function(){gx.O.AV27ObsLancamentoFiscalCodigo=gx.num.intval(this.val())},val:function(){return gx.fn.getIntegerValue("vOBSLANCAMENTOFISCALCODIGO",'.')},nac:gx.falseFn};
   GXValidFnc[16]={fld:"TXTTITAPL2", format:0,grid:0};
   GXValidFnc[18]={lvl:0,type:"svchar",len:70,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[this.GridContainer],fld:"vOBSLANCAMENTOFISCALDESCRICAO",gxz:"ZV28ObsLancamentoFiscalDescricao",gxold:"OV28ObsLancamentoFiscalDescricao",gxvar:"AV28ObsLancamentoFiscalDescricao",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",v2v:function(Value){gx.O.AV28ObsLancamentoFiscalDescricao=Value},v2z:function(Value){gx.O.ZV28ObsLancamentoFiscalDescricao=Value},v2c:function(){gx.fn.setControlValue("vOBSLANCAMENTOFISCALDESCRICAO",gx.O.AV28ObsLancamentoFiscalDescricao,0)},c2v:function(){gx.O.AV28ObsLancamentoFiscalDescricao=this.val()},val:function(){return gx.fn.getControlValue("vOBSLANCAMENTOFISCALDESCRICAO")},nac:gx.falseFn};
   ...
   GXValidFnc[49]={lvl:2,type:"int",len:4,dec:0,sign:false,pic:"ZZZ9",ro:1,isacc:0,grid:48,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"OBSLANCAMENTOFISCALCODIGO",gxz:"Z5488ObsLancamentoFiscalCodigo",gxold:"O5488ObsLancamentoFiscalCodigo",gxvar:"A5488ObsLancamentoFiscalCodigo",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.A5488ObsLancamentoFiscalCodigo=gx.num.intval(Value)},v2z:function(Value){gx.O.Z5488ObsLancamentoFiscalCodigo=gx.num.intval(Value)},v2c:function(row){gx.fn.setGridControlValue("OBSLANCAMENTOFISCALCODIGO",row || gx.fn.currentGridRowImpl(48),gx.O.A5488ObsLancamentoFiscalCodigo,0)},c2v:function(){gx.O.A5488ObsLancamentoFiscalCodigo=gx.num.intval(this.val())},val:function(row){return gx.fn.getGridIntegerValue("OBSLANCAMENTOFISCALCODIGO",row || gx.fn.currentGridRowImpl(48),'.')},nac:gx.falseFn};
   GXValidFnc[50]={lvl:2,type:"svchar",len:70,dec:0,sign:false,ro:1,isacc:0,grid:48,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"OBSLANCAMENTOFISCALDESCRICAO",gxz:"Z5484ObsLancamentoFiscalDescricao",gxold:"O5484ObsLancamentoFiscalDescricao",gxvar:"A5484ObsLancamentoFiscalDescricao",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){gx.O.A5484ObsLancamentoFiscalDescricao=Value},v2z:function(Value){gx.O.Z5484ObsLancamentoFiscalDescricao=Value},v2c:function(row){gx.fn.setGridControlValue("OBSLANCAMENTOFISCALDESCRICAO",row || gx.fn.currentGridRowImpl(48),gx.O.A5484ObsLancamentoFiscalDescricao,0)},c2v:function(){gx.O.A5484ObsLancamentoFiscalDescricao=this.val()},val:function(row){return gx.fn.getGridControlValue("OBSLANCAMENTOFISCALDESCRICAO",row || gx.fn.currentGridRowImpl(48))},nac:gx.falseFn};
   ...
   this.AV27ObsLancamentoFiscalCodigo = 0 ;
   this.ZV27ObsLancamentoFiscalCodigo = 0 ;
   this.OV27ObsLancamentoFiscalCodigo = 0 ;
   this.AV28ObsLancamentoFiscalDescricao = "" ;
   this.ZV28ObsLancamentoFiscalDescricao = "" ;
   this.OV28ObsLancamentoFiscalDescricao = "" ;
   this.AV5Pagina = 0 ;
   this.ZV5Pagina = 0 ;
   this.OV5Pagina = 0 ;
   this.AV6PaginaAux = 0 ;
   ...
   this.AV32Pgmname = "" ;
   this.Events = {"e11vy2_client": ["'ANTERIOR'", true] ,"e12vy2_client": ["'PROXIMO'", true] ,"e17vy2_client": ["VPAGINA.CLICK", true] ,"e13vy2_client": ["'NOVO'", true] ,"e14vy2_client": ["'FECHAR'", true] ,"e15vy2_client": ["'IMPRIMIR'", true] ,"e16vy2_client": ["'PROCURAR'", true] ,"e20vy2_client": ["'ALTERAR'", true] ,"e21vy2_client": ["'EXCLUIR'", true] ,"e22vy2_client": ["'CONSULTAR'", true] ,"e23vy2_client": ["'ATUALIZAPAGINA'", true] ,"e25vy2_client": ["ENTER", true] ,"e26vy2_client": ["CANCEL", true]};
   this.EvtParms["REFRESH"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV27ObsLancamentoFiscalCodigo',fld:'vOBSLANCAMENTOFISCALCODIGO'},{av:'AV28ObsLancamentoFiscalDescricao',fld:'vOBSLANCAMENTOFISCALDESCRICAO'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV7bmpAlt',fld:'vBMPALT'},{av:'gx.fn.getCtrlProperty("vBMPALT","Tooltiptext")',ctrl:'vBMPALT',prop:'Tooltiptext'},{av:'AV8bmpExc',fld:'vBMPEXC'},{av:'gx.fn.getCtrlProperty("vBMPEXC","Tooltiptext")',ctrl:'vBMPEXC',prop:'Tooltiptext'},{av:'AV16bmpCon',fld:'vBMPCON'},{av:'gx.fn.getCtrlProperty("vBMPCON","Tooltiptext")',ctrl:'vBMPCON',prop:'Tooltiptext'},{av:'AV29SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'AV32Pgmname',fld:'vPGMNAME'}],[]];
   this.EvtParms["GRID.REFRESH"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV27ObsLancamentoFiscalCodigo',fld:'vOBSLANCAMENTOFISCALCODIGO'},{av:'AV28ObsLancamentoFiscalDescricao',fld:'vOBSLANCAMENTOFISCALDESCRICAO'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV7bmpAlt',fld:'vBMPALT'},{av:'gx.fn.getCtrlProperty("vBMPALT","Tooltiptext")',ctrl:'vBMPALT',prop:'Tooltiptext'},{av:'AV8bmpExc',fld:'vBMPEXC'},{av:'gx.fn.getCtrlProperty("vBMPEXC","Tooltiptext")',ctrl:'vBMPEXC',prop:'Tooltiptext'},{av:'AV16bmpCon',fld:'vBMPCON'},{av:'gx.fn.getCtrlProperty("vBMPCON","Tooltiptext")',ctrl:'vBMPCON',prop:'Tooltiptext'},{av:'AV29SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'AV32Pgmname',fld:'vPGMNAME'}],[{ctrl:'OBSLANCAMENTOFISCALCODIGO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("OBSLANCAMENTOFISCALCODIGO","Title")',ctrl:'OBSLANCAMENTOFISCALCODIGO',prop:'Title'},{av:'AV12Imagem',fld:'vIMAGEM'},{ctrl:'OBSLANCAMENTOFISCALDESCRICAO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("OBSLANCAMENTOFISCALDESCRICAO","Title")',ctrl:'OBSLANCAMENTOFISCALDESCRICAO',prop:'Title'},{av:'AV6PaginaAux',fld:'vPAGINAAUX'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV10NumPagina',fld:'vNUMPAGINA'},{av:'AV29SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'gx.fn.getCtrlProperty("BTNANTERIOR","Enabled")',ctrl:'BTNANTERIOR',prop:'Enabled'},{av:'gx.fn.getCtrlProperty("BTNPROXIMO","Enabled")',ctrl:'BTNPROXIMO',prop:'Enabled'},{av:'AV23filtros',fld:'vFILTROS'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV27ObsLancamentoFiscalCodigo',fld:'vOBSLANCAMENTOFISCALCODIGO'},{av:'AV28ObsLancamentoFiscalDescricao',fld:'vOBSLANCAMENTOFISCALDESCRICAO'}]];
   ...
   this.EvtParms["'NOVO'"] = [[{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV27ObsLancamentoFiscalCodigo',fld:'vOBSLANCAMENTOFISCALCODIGO'},{av:'AV28ObsLancamentoFiscalDescricao',fld:'vOBSLANCAMENTOFISCALDESCRICAO'},{av:'AV32Pgmname',fld:'vPGMNAME'}],[{av:'AV23filtros',fld:'vFILTROS'}]];
   ...
   this.EvtParms["'ALTERAR'"] = [[{av:'A5488ObsLancamentoFiscalCodigo',fld:'OBSLANCAMENTOFISCALCODIGO'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV27ObsLancamentoFiscalCodigo',fld:'vOBSLANCAMENTOFISCALCODIGO'},{av:'AV28ObsLancamentoFiscalDescricao',fld:'vOBSLANCAMENTOFISCALDESCRICAO'},{av:'AV32Pgmname',fld:'vPGMNAME'}],[{av:'A5488ObsLancamentoFiscalCodigo',fld:'OBSLANCAMENTOFISCALCODIGO'},{av:'AV23filtros',fld:'vFILTROS'}]];
   this.EvtParms["'EXCLUIR'"] = [[{av:'A5488ObsLancamentoFiscalCodigo',fld:'OBSLANCAMENTOFISCALCODIGO'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV27ObsLancamentoFiscalCodigo',fld:'vOBSLANCAMENTOFISCALCODIGO'},{av:'AV28ObsLancamentoFiscalDescricao',fld:'vOBSLANCAMENTOFISCALDESCRICAO'},{av:'AV32Pgmname',fld:'vPGMNAME'}],[{av:'A5488ObsLancamentoFiscalCodigo',fld:'OBSLANCAMENTOFISCALCODIGO'},{av:'AV23filtros',fld:'vFILTROS'}]];
   this.EvtParms["'CONSULTAR'"] = [[{av:'A5488ObsLancamentoFiscalCodigo',fld:'OBSLANCAMENTOFISCALCODIGO'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV27ObsLancamentoFiscalCodigo',fld:'vOBSLANCAMENTOFISCALCODIGO'},{av:'AV28ObsLancamentoFiscalDescricao',fld:'vOBSLANCAMENTOFISCALDESCRICAO'},{av:'AV32Pgmname',fld:'vPGMNAME'}],[{av:'A5488ObsLancamentoFiscalCodigo',fld:'OBSLANCAMENTOFISCALCODIGO'},{av:'AV23filtros',fld:'vFILTROS'}]];
...
gx.setParentObj(new hobslancamentofiscal());
