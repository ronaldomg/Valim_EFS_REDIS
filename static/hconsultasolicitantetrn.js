/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 18:50:5.76
*/
gx.evt.autoSkip = false;
gx.define('hconsultasolicitantetrn', false, function () {
   this.ServerClass =  "hconsultasolicitantetrn" ;
   this.PackageName =  "" ;
   ...
   this.e181h32_client=function()
   {
      this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e111h32_client=function()
   {
      this.executeServerEvent("'GXM_FIRST'", true, null, false, false);
   };
   this.e121h32_client=function()
   {
      this.executeServerEvent("'GXM_PREVIOUS'", true, null, false, false);
   };
   this.e131h32_client=function()
   {
      this.executeServerEvent("'GXM_NEXT'", true, null, false, false);
   };
   this.e141h32_client=function()
   {
      this.executeServerEvent("'GXM_LAST'", true, null, false, false);
   };
   this.e151h32_client=function()
   {
      this.executeServerEvent("'PROCURAR'", false, null, false, false);
   };
   this.e161h32_client=function()
   {
      this.executeServerEvent("'NOVO'", true, null, false, false);
   };
   this.e211h32_client=function()
   {
      this.executeServerEvent("'ALTERAR'", true, arguments[0], false, false);
   };
   this.e221h32_client=function()
   {
      this.executeServerEvent("'ATUALIZAPAGINA'", true, arguments[0], false, false);
   };
   this.e231h31_client=function()
   {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",23,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"hconsultasolicitantetrn",[],false,1,true,true,0,false,false,false,"",0,"px","Novo registro",true,false,false,null,null,false,"",false,[1,1,1,1]);
   var GridContainer = this.GridContainer;
   GridContainer.addSingleLineEdit(4028,24,"SOLICITANTECODIGO","","","SolicitanteCodigo","int",0,"px",4,4,"right",null,[],4028,"SolicitanteCodigo",true,0,false,false,"Attribute",1,"");
   ...
   GridContainer.addSingleLineEdit("Email",31,"vEMAIL","","","email","svchar",0,"px",15,15,"left",null,[],"Email","email",true,0,false,false,"Attribute",1,"");
   GridContainer.addBitmap("&Bmpalt","vBMPALT",32,0,"px",17,"px","e211h32_client","","Alterar","Image","");
   ...
   GXValidFnc[32]={lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:23,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"vBMPALT",gxz:"ZV21bmpAlt",gxold:"OV21bmpAlt",gxvar:"AV21bmpAlt",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.AV21bmpAlt=Value},v2z:function(Value){gx.O.ZV21bmpAlt=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vBMPALT",row || gx.fn.currentGridRowImpl(23),gx.O.AV21bmpAlt,gx.O.AV29Bmpalt_GXI)},c2v:function(){gx.O.AV29Bmpalt_GXI=this.val_GXI();gx.O.AV21bmpAlt=this.val()},val:function(row){return gx.fn.getGridControlValue("vBMPALT",row || gx.fn.currentGridRowImpl(23))},val_GXI:function(row){return gx.fn.getGridControlValue("vBMPALT_GXI",row || gx.fn.currentGridRowImpl(23))}, gxvar_GXI:'AV29Bmpalt_GXI',nac:gx.falseFn};
   ...
   this.Events = {"e181h32_client": ["ENTER", true] ,"e111h32_client": ["'GXM_FIRST'", true] ,"e121h32_client": ["'GXM_PREVIOUS'", true] ,"e131h32_client": ["'GXM_NEXT'", true] ,"e141h32_client": ["'GXM_LAST'", true] ,"e151h32_client": ["'PROCURAR'", true] ,"e161h32_client": ["'NOVO'", true] ,"e211h32_client": ["'ALTERAR'", true] ,"e221h32_client": ["'ATUALIZAPAGINA'", true] ,"e231h31_client": ["CANCEL", true]};
...
gx.setParentObj(new hconsultasolicitantetrn());
