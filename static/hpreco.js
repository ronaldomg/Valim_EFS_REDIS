/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 13:4:1.57
*/
gx.evt.autoSkip = false;
gx.define('hpreco', false, function () {
   this.ServerClass =  "hpreco" ;
   this.PackageName =  "" ;
   ...
   this.e11pm2_client=function()
   {
      this.executeServerEvent("'ANTERIOR'", true, null, false, false);
   };
   this.e12pm2_client=function()
   {
      this.executeServerEvent("'PROXIMO'", true, null, false, false);
   };
   this.e17pm2_client=function()
   {
      this.executeServerEvent("VPAGINA.CLICK", true, null, false, true);
   };
   this.e13pm2_client=function()
   {
      this.executeServerEvent("'NOVO'", true, null, false, false);
   };
   this.e14pm2_client=function()
   {
      this.executeServerEvent("'FECHAR'", false, null, false, false);
   };
   this.e15pm2_client=function()
   {
      this.executeServerEvent("'IMPRIMIR'", true, null, false, false);
   };
   this.e16pm2_client=function()
   {
      this.executeServerEvent("'PROCURAR'", false, null, false, false);
   };
   this.e21pm2_client=function()
   {
      this.executeServerEvent("'ALTERAR'", true, arguments[0], false, false);
   };
   this.e22pm2_client=function()
   {
      this.executeServerEvent("'EXCLUIR'", true, arguments[0], false, false);
   };
   this.e23pm2_client=function()
   {
      this.executeServerEvent("'CONSULTAR'", true, arguments[0], false, false);
   };
   this.e24pm2_client=function()
   {
      this.executeServerEvent("'REGISTRAPRECOPRODUTO'", true, arguments[0], false, false);
   };
   this.e25pm2_client=function()
   {
      this.executeServerEvent("'ATUALIZAPAGINA'", true, arguments[0], false, false);
   };
   this.e26pm2_client=function()
   {
      this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e27pm2_client=function()
   {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",53,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"hpreco",[],false,1,true,true,0,false,false,false,"",0,"px","Novo registro",true,false,false,null,null,false,"",false,[1,1,1,1]);
   ...
   GridContainer.addSingleLineEdit(711,55,"PRECODESCRICAO","","","PrecoDescricao","svchar",0,"px",30,30,"left",null,[],711,"PrecoDescricao",true,0,false,false,"Attribute",1,"");
   GridContainer.addComboBox(722,56,"PRECOTIPO","Tipo","PrecoTipo","char",null,0,true,false,0,"px","");
   GridContainer.addBitmap("&Bmpprepro","vBMPPREPRO",57,0,"px",17,"px","e24pm2_client","","Parâmetros","Image","GridColumnImage");
   GridContainer.addBitmap("&Bmpalt","vBMPALT",58,0,"px",17,"px","e21pm2_client","","Alterar","Image","GridColumnImage");
   GridContainer.addBitmap("&Bmpexc","vBMPEXC",59,0,"px",17,"px","e22pm2_client","","Excluir","Image","GridColumnImage");
   GridContainer.addBitmap("&Bmpcon","vBMPCON",60,0,"px",17,"px","e23pm2_client","","Consultar","Image","GridColumnImage");
   ...
   GXValidFnc[57]={lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:53,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"vBMPPREPRO",gxz:"ZV29bmpPrePro",gxold:"OV29bmpPrePro",gxvar:"AV29bmpPrePro",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.AV29bmpPrePro=Value},v2z:function(Value){gx.O.ZV29bmpPrePro=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vBMPPREPRO",row || gx.fn.currentGridRowImpl(53),gx.O.AV29bmpPrePro,gx.O.AV36Bmpprepro_GXI)},c2v:function(){gx.O.AV36Bmpprepro_GXI=this.val_GXI();gx.O.AV29bmpPrePro=this.val()},val:function(row){return gx.fn.getGridControlValue("vBMPPREPRO",row || gx.fn.currentGridRowImpl(53))},val_GXI:function(row){return gx.fn.getGridControlValue("vBMPPREPRO_GXI",row || gx.fn.currentGridRowImpl(53))}, gxvar_GXI:'AV36Bmpprepro_GXI',nac:gx.falseFn};
   GXValidFnc[58]={lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:53,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"vBMPALT",gxz:"ZV7bmpAlt",gxold:"OV7bmpAlt",gxvar:"AV7bmpAlt",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.AV7bmpAlt=Value},v2z:function(Value){gx.O.ZV7bmpAlt=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vBMPALT",row || gx.fn.currentGridRowImpl(53),gx.O.AV7bmpAlt,gx.O.AV37Bmpalt_GXI)},c2v:function(){gx.O.AV37Bmpalt_GXI=this.val_GXI();gx.O.AV7bmpAlt=this.val()},val:function(row){return gx.fn.getGridControlValue("vBMPALT",row || gx.fn.currentGridRowImpl(53))},val_GXI:function(row){return gx.fn.getGridControlValue("vBMPALT_GXI",row || gx.fn.currentGridRowImpl(53))}, gxvar_GXI:'AV37Bmpalt_GXI',nac:gx.falseFn};
   GXValidFnc[59]={lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:53,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"vBMPEXC",gxz:"ZV8bmpExc",gxold:"OV8bmpExc",gxvar:"AV8bmpExc",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.AV8bmpExc=Value},v2z:function(Value){gx.O.ZV8bmpExc=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vBMPEXC",row || gx.fn.currentGridRowImpl(53),gx.O.AV8bmpExc,gx.O.AV38Bmpexc_GXI)},c2v:function(){gx.O.AV38Bmpexc_GXI=this.val_GXI();gx.O.AV8bmpExc=this.val()},val:function(row){return gx.fn.getGridControlValue("vBMPEXC",row || gx.fn.currentGridRowImpl(53))},val_GXI:function(row){return gx.fn.getGridControlValue("vBMPEXC_GXI",row || gx.fn.currentGridRowImpl(53))}, gxvar_GXI:'AV38Bmpexc_GXI',nac:gx.falseFn};
   GXValidFnc[60]={lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:53,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"vBMPCON",gxz:"ZV16bmpCon",gxold:"OV16bmpCon",gxvar:"AV16bmpCon",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.AV16bmpCon=Value},v2z:function(Value){gx.O.ZV16bmpCon=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vBMPCON",row || gx.fn.currentGridRowImpl(53),gx.O.AV16bmpCon,gx.O.AV39Bmpcon_GXI)},c2v:function(){gx.O.AV39Bmpcon_GXI=this.val_GXI();gx.O.AV16bmpCon=this.val()},val:function(row){return gx.fn.getGridControlValue("vBMPCON",row || gx.fn.currentGridRowImpl(53))},val_GXI:function(row){return gx.fn.getGridControlValue("vBMPCON_GXI",row || gx.fn.currentGridRowImpl(53))}, gxvar_GXI:'AV39Bmpcon_GXI',nac:gx.falseFn};
   ...
   this.AV34Pgmname = "" ;
   this.Events = {"e11pm2_client": ["'ANTERIOR'", true] ,"e12pm2_client": ["'PROXIMO'", true] ,"e17pm2_client": ["VPAGINA.CLICK", true] ,"e13pm2_client": ["'NOVO'", true] ,"e14pm2_client": ["'FECHAR'", true] ,"e15pm2_client": ["'IMPRIMIR'", true] ,"e16pm2_client": ["'PROCURAR'", true] ,"e21pm2_client": ["'ALTERAR'", true] ,"e22pm2_client": ["'EXCLUIR'", true] ,"e23pm2_client": ["'CONSULTAR'", true] ,"e24pm2_client": ["'REGISTRAPRECOPRODUTO'", true] ,"e25pm2_client": ["'ATUALIZAPAGINA'", true] ,"e26pm2_client": ["ENTER", true] ,"e27pm2_client": ["CANCEL", true]};
   ...
   this.EvtParms["GRID.REFRESH"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV17EmpresaPadrao',fld:'vEMPRESAPADRAO'},{av:'AV29bmpPrePro',fld:'vBMPPREPRO'},{av:'gx.fn.getCtrlProperty("vBMPPREPRO","Tooltiptext")',ctrl:'vBMPPREPRO',prop:'Tooltiptext'},{av:'AV31SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'AV34Pgmname',fld:'vPGMNAME'}],[{ctrl:'PRECOID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("PRECOID","Title")',ctrl:'PRECOID',prop:'Title'},{av:'AV12Imagem',fld:'vIMAGEM'},{ctrl:'PRECODESCRICAO',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("PRECODESCRICAO","Title")',ctrl:'PRECODESCRICAO',prop:'Title'},{av:'AV6PaginaAux',fld:'vPAGINAAUX'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV10NumPagina',fld:'vNUMPAGINA'},{av:'AV31SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'gx.fn.getCtrlProperty("BTNANTERIOR","Enabled")',ctrl:'BTNANTERIOR',prop:'Enabled'},{av:'gx.fn.getCtrlProperty("BTNPROXIMO","Enabled")',ctrl:'BTNPROXIMO',prop:'Enabled'},{av:'AV25filtros',fld:'vFILTROS'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'}]];
   this.EvtParms["'ANTERIOR'"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV17EmpresaPadrao',fld:'vEMPRESAPADRAO'},{av:'AV29bmpPrePro',fld:'vBMPPREPRO'},{av:'gx.fn.getCtrlProperty("vBMPPREPRO","Tooltiptext")',ctrl:'vBMPPREPRO',prop:'Tooltiptext'},{av:'AV31SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'AV34Pgmname',fld:'vPGMNAME'},{av:'AV5Pagina',fld:'vPAGINA'}],[{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["'PROXIMO'"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV17EmpresaPadrao',fld:'vEMPRESAPADRAO'},{av:'AV29bmpPrePro',fld:'vBMPPREPRO'},{av:'gx.fn.getCtrlProperty("vBMPPREPRO","Tooltiptext")',ctrl:'vBMPPREPRO',prop:'Tooltiptext'},{av:'AV31SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'AV34Pgmname',fld:'vPGMNAME'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV6PaginaAux',fld:'vPAGINAAUX'}],[{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["GRID.LOAD"] = [[],[{av:'AV7bmpAlt',fld:'vBMPALT'},{av:'gx.fn.getCtrlProperty("vBMPALT","Tooltiptext")',ctrl:'vBMPALT',prop:'Tooltiptext'},{av:'AV8bmpExc',fld:'vBMPEXC'},{av:'gx.fn.getCtrlProperty("vBMPEXC","Tooltiptext")',ctrl:'vBMPEXC',prop:'Tooltiptext'},{av:'AV16bmpCon',fld:'vBMPCON'},{av:'gx.fn.getCtrlProperty("vBMPCON","Tooltiptext")',ctrl:'vBMPCON',prop:'Tooltiptext'},{av:'AV29bmpPrePro',fld:'vBMPPREPRO'},{av:'gx.fn.getCtrlProperty("vBMPPREPRO","Tooltiptext")',ctrl:'vBMPPREPRO',prop:'Tooltiptext'},{av:'gx.fn.getCtrlProperty("vBMPPREPRO","Link")',ctrl:'vBMPPREPRO',prop:'Link'}]];
   this.EvtParms["VPAGINA.CLICK"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV17EmpresaPadrao',fld:'vEMPRESAPADRAO'},{av:'AV29bmpPrePro',fld:'vBMPPREPRO'},{av:'gx.fn.getCtrlProperty("vBMPPREPRO","Tooltiptext")',ctrl:'vBMPPREPRO',prop:'Tooltiptext'},{av:'AV31SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'AV34Pgmname',fld:'vPGMNAME'},{av:'AV5Pagina',fld:'vPAGINA'}],[{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["'NOVO'"] = [[{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV34Pgmname',fld:'vPGMNAME'}],[{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["'FECHAR'"] = [[{av:'AV34Pgmname',fld:'vPGMNAME'}],[]];
   this.EvtParms["'IMPRIMIR'"] = [[{av:'AV34Pgmname',fld:'vPGMNAME'},{av:'AV35Pgmdesc',fld:'vPGMDESC'}],[{av:'AV20OrdenacaoDescricao',fld:'vORDENACAODESCRICAO'},{av:'AV19NomeRelativo',fld:'vNOMERELATIVO'},{av:'AV18NomeAbsoluto',fld:'vNOMEABSOLUTO'},{av:'AV40Qtdpaggeradas',fld:'vQTDPAGGERADAS'}]];
   this.EvtParms["'PROCURAR'"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV17EmpresaPadrao',fld:'vEMPRESAPADRAO'},{av:'AV29bmpPrePro',fld:'vBMPPREPRO'},{av:'gx.fn.getCtrlProperty("vBMPPREPRO","Tooltiptext")',ctrl:'vBMPPREPRO',prop:'Tooltiptext'},{av:'AV31SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'AV34Pgmname',fld:'vPGMNAME'},{av:'AV5Pagina',fld:'vPAGINA'}],[{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["'ALTERAR'"] = [[{av:'A710PrecoId',fld:'PRECOID'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV34Pgmname',fld:'vPGMNAME'}],[{av:'A710PrecoId',fld:'PRECOID'},{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["'EXCLUIR'"] = [[{av:'A710PrecoId',fld:'PRECOID'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV34Pgmname',fld:'vPGMNAME'}],[{av:'A710PrecoId',fld:'PRECOID'},{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["'CONSULTAR'"] = [[{av:'A710PrecoId',fld:'PRECOID'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV34Pgmname',fld:'vPGMNAME'}],[{av:'A710PrecoId',fld:'PRECOID'},{av:'AV25filtros',fld:'vFILTROS'}]];
   this.EvtParms["'REGISTRAPRECOPRODUTO'"] = [[{av:'A4343PrecoSnCalcularSistema',fld:'PRECOSNCALCULARSISTEMA'},{av:'A722PrecoTipo',fld:'PRECOTIPO'},{av:'A710PrecoId',fld:'PRECOID'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV23PrecoId',fld:'vPRECOID'},{av:'AV27TipoPreco',fld:'vTIPOPRECO'},{av:'AV24PrecoDescricao',fld:'vPRECODESCRICAO'},{av:'AV34Pgmname',fld:'vPGMNAME'}],[{av:'A710PrecoId',fld:'PRECOID'},{av:'AV25filtros',fld:'vFILTROS'}]];
