/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 11:48:6.54
*/
gx.evt.autoSkip = false;
gx.define('hautor', false, function () {
   this.ServerClass =  "hautor" ;
   this.PackageName =  "" ;
   ...
   this.e240d2_client=function()
   {
      this.executeServerEvent("'ATUALIZAPAGINA'", true, arguments[0], false, false);
   };
   this.e250d2_client=function()
   {
      this.executeServerEvent("ENTER", true, arguments[0], false, false);
   };
   this.e260d2_client=function()
   {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",28,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"hautor",[],false,1,true,true,0,false,false,false,"",0,"px","Novo registro",true,false,false,null,null,false,"",false,[1,1,1,1]);
   var GridContainer = this.GridContainer;
   GridContainer.addSingleLineEdit(49,29,"AUTORID","","","AutorId","int",0,"px",7,7,"right",null,[],49,"AutorId",true,0,false,false,"Attribute",1,"");
   GridContainer.addSingleLineEdit(50,30,"AUTORNOME","","","AutorNome","svchar",0,"px",40,40,"left",null,[],50,"AutorNome",true,0,false,false,"SemQuebraGrid",1,"");
   GridContainer.addBitmap("&Bmpalt","vBMPALT",31,0,"px",17,"px","e200d2_client","","Alterar","Image","GridColumnImage");
   GridContainer.addBitmap("&Bmpexc","vBMPEXC",32,0,"px",17,"px","e210d2_client","","Excluir","Image","GridColumnImage");
   GridContainer.addBitmap("&Bmpcon","vBMPCON",33,0,"px",17,"px","e220d2_client","","Consultar","Image","GridColumnImage");
   ...
   GXValidFnc[29]={lvl:2,type:"int",len:7,dec:0,sign:false,pic:"ZZZZZZ9",ro:1,isacc:0,grid:28,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"AUTORID",gxz:"Z49AutorId",gxold:"O49AutorId",gxvar:"A49AutorId",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){gx.O.A49AutorId=gx.num.intval(Value)},v2z:function(Value){gx.O.Z49AutorId=gx.num.intval(Value)},v2c:function(row){gx.fn.setGridControlValue("AUTORID",row || gx.fn.currentGridRowImpl(28),gx.O.A49AutorId,0)},c2v:function(){gx.O.A49AutorId=gx.num.intval(this.val())},val:function(row){return gx.fn.getGridIntegerValue("AUTORID",row || gx.fn.currentGridRowImpl(28),'.')},nac:gx.falseFn};
   GXValidFnc[30]={lvl:2,type:"svchar",len:40,dec:0,sign:false,ro:1,isacc:0,grid:28,gxgrid:this.GridContainer,fnc:null,isvalid:null,rgrid:[],fld:"AUTORNOME",gxz:"Z50AutorNome",gxold:"O50AutorNome",gxvar:"A50AutorNome",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){gx.O.A50AutorNome=Value},v2z:function(Value){gx.O.Z50AutorNome=Value},v2c:function(row){gx.fn.setGridControlValue("AUTORNOME",row || gx.fn.currentGridRowImpl(28),gx.O.A50AutorNome,0);if (typeof(this.dom_hdl) == 'function') this.dom_hdl.call(gx.O);},c2v:function(){gx.O.A50AutorNome=this.val()},val:function(row){return gx.fn.getGridControlValue("AUTORNOME",row || gx.fn.currentGridRowImpl(28))},nac:gx.falseFn};
   ...
   this.Events = {"e110d2_client": ["'ANTERIOR'", true] ,"e120d2_client": ["'PROXIMO'", true] ,"e200d2_client": ["'ALTERAR'", true] ,"e210d2_client": ["'EXCLUIR'", true] ,"e220d2_client": ["'CONSULTAR'", true] ,"e160d2_client": ["VPAGINA.CLICK", true] ,"e130d2_client": ["'NOVO'", true] ,"e140d2_client": ["'FECHAR'", true] ,"e230d2_client": ["'ATUALIZAR'", true] ,"e150d2_client": ["'IMPRIMIR'", true] ,"e240d2_client": ["'ATUALIZAPAGINA'", true] ,"e250d2_client": ["ENTER", true] ,"e260d2_client": ["CANCEL", true]};
   ...
   this.EvtParms["GRID.REFRESH"] = [[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows'},{av:'AV11OrderedBy',fld:'vORDEREDBY'},{av:'AV25SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'}],[{ctrl:'AUTORID',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("AUTORID","Title")',ctrl:'AUTORID',prop:'Title'},{av:'AV12Imagem',fld:'vIMAGEM'},{ctrl:'AUTORNOME',prop:'Titleformat'},{av:'gx.fn.getCtrlProperty("AUTORNOME","Title")',ctrl:'AUTORNOME',prop:'Title'},{av:'AV6PaginaAux',fld:'vPAGINAAUX'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV10NumPagina',fld:'vNUMPAGINA'},{av:'AV25SnRecuperaFiltro',fld:'vSNRECUPERAFILTRO'},{av:'gx.fn.getCtrlProperty("BTNANTERIOR","Enabled")',ctrl:'BTNANTERIOR',prop:'Enabled'},{av:'gx.fn.getCtrlProperty("BTNPROXIMO","Enabled")',ctrl:'BTNPROXIMO',prop:'Enabled'},{av:'AV22filtros',fld:'vFILTROS'},{av:'AV11OrderedBy',fld:'vORDEREDBY'}]];
   ...
   this.EvtParms["'ALTERAR'"] = [[{av:'A49AutorId',fld:'AUTORID'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'}],[{av:'A49AutorId',fld:'AUTORID'},{av:'AV22filtros',fld:'vFILTROS'}]];
   this.EvtParms["'EXCLUIR'"] = [[{av:'A49AutorId',fld:'AUTORID'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'}],[{av:'A49AutorId',fld:'AUTORID'},{av:'AV22filtros',fld:'vFILTROS'}]];
   this.EvtParms["'CONSULTAR'"] = [[{av:'A49AutorId',fld:'AUTORID'},{av:'AV5Pagina',fld:'vPAGINA'},{av:'AV11OrderedBy',fld:'vORDEREDBY'}],[{av:'A49AutorId',fld:'AUTORID'},{av:'AV22filtros',fld:'vFILTROS'}]];
   ...
   this.EvtParms["'IMPRIMIR'"] = [[{av:'AV30Pgmdesc',fld:'vPGMDESC'}],[{av:'AV19OrdenacaoDescricao',fld:'vORDENACAODESCRICAO'},{av:'AV18NomeRelativo',fld:'vNOMERELATIVO'},{av:'AV17NomeAbsoluto',fld:'vNOMEABSOLUTO'},{av:'AV26QtdPagGeradas',fld:'vQTDPAGGERADAS'}]];
