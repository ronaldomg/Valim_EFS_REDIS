/**@preserve  GeneXus Java 10_3_12-110051 on December 12, 2020 18:45:25.65
*/
gx.evt.autoSkip = false;
gx.define('hmodaltipomovimentoosxsaida', false, function () {
   this.ServerClass =  "hmodaltipomovimentoosxsaida" ;
   this.PackageName =  "" ;
   ...
   this.e131fz2_client=function()
   {
      this.executeServerEvent("ENTER", true, null, false, false);
   };
   this.e141fz2_client=function()
   {
      this.executeServerEvent("'LIMPARCAMPOS'", true, null, false, false);
   };
   this.e151fz2_client=function()
   {
      this.executeServerEvent("'FECHAR'", false, null, false, false);
   };
   this.e191fz2_client=function()
   {
      this.executeServerEvent("CANCEL", true, null, false, false);
   };
   this.GXValidFnc = [];
   var GXValidFnc = this.GXValidFnc ;
   this.GXCtrlIds=[2,7,14,16,19,21,24,26,29,31,34,36,39,41,44,46,49];
   ...
   GXValidFnc[36]={lvl:0,type:"char",len:1,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[],fld:"CTLSNDEVOLUCAOSAIDA",gxz:"ZV58GXV10",gxold:"OV58GXV10",gxvar:"GXV10",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"checkbox",v2v:function(Value){gx.O.GXV10=Value},v2z:function(Value){gx.O.ZV58GXV10=Value},v2c:function(){gx.fn.setCheckBoxValue("CTLSNDEVOLUCAOSAIDA",gx.O.GXV10,"S")},c2v:function(){gx.O.GXV10=this.val()},val:function(){return gx.fn.getControlValue("CTLSNDEVOLUCAOSAIDA")},nac:gx.falseFn,values:['S','N']};
   ...
   GXValidFnc[41]={lvl:0,type:"char",len:1,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[],fld:"CTLSNTROCA",gxz:"ZV60GXV12",gxold:"OV60GXV12",gxvar:"GXV12",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"checkbox",v2v:function(Value){gx.O.GXV12=Value},v2z:function(Value){gx.O.ZV60GXV12=Value},v2c:function(){gx.fn.setCheckBoxValue("CTLSNTROCA",gx.O.GXV12,"S")},c2v:function(){gx.O.GXV12=this.val()},val:function(){return gx.fn.getControlValue("CTLSNTROCA")},nac:gx.falseFn,values:['S','N']};
   ...
   GXValidFnc[46]={lvl:0,type:"char",len:1,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[],fld:"CTLSNTRANSFERENCIA",gxz:"ZV62GXV14",gxold:"OV62GXV14",gxvar:"GXV14",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"checkbox",v2v:function(Value){gx.O.GXV14=Value},v2z:function(Value){gx.O.ZV62GXV14=Value},v2c:function(){gx.fn.setCheckBoxValue("CTLSNTRANSFERENCIA",gx.O.GXV14,"S")},c2v:function(){gx.O.GXV14=this.val()},val:function(){return gx.fn.getControlValue("CTLSNTRANSFERENCIA")},nac:gx.falseFn,values:['S','N']};
   GXValidFnc[49]={lvl:0,type:"char",len:1,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[],fld:"CTLSNCUPOMFISCALELE",gxz:"ZV63GXV15",gxold:"OV63GXV15",gxvar:"GXV15",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"checkbox",v2v:function(Value){gx.O.GXV15=Value},v2z:function(Value){gx.O.ZV63GXV15=Value},v2c:function(){gx.fn.setCheckBoxValue("CTLSNCUPOMFISCALELE",gx.O.GXV15,"S")},c2v:function(){gx.O.GXV15=this.val()},val:function(){return gx.fn.getControlValue("CTLSNCUPOMFISCALELE")},nac:gx.falseFn,values:['S','N']};
   this.GXV1 = "" ;
   this.ZV49GXV1 = "" ;
   this.OV49GXV1 = "" ;
   this.GXV2 = "" ;
   ...
   this.Events = {"e131fz2_client": ["ENTER", true] ,"e141fz2_client": ["'LIMPARCAMPOS'", true] ,"e151fz2_client": ["'FECHAR'", true] ,"e191fz2_client": ["CANCEL", true] ,"e171fz1_client": ["'MARCARTODOSMOV'", false] ,"e181fz1_client": ["'DESMARCARTODOSMOV'", false]};
   ...
   this.addBCProperty("Filtros", ["SNDevolucaoSaida"], this.GXValidFnc[36], "AV28filtros");
   this.addBCProperty("Filtros", ["SNDAV"], this.GXValidFnc[39], "AV28filtros");
   this.addBCProperty("Filtros", ["SNTroca"], this.GXValidFnc[41], "AV28filtros");
   this.addBCProperty("Filtros", ["SNCupomFiscal"], this.GXValidFnc[44], "AV28filtros");
   this.addBCProperty("Filtros", ["SNTransferencia"], this.GXValidFnc[46], "AV28filtros");
   this.addBCProperty("Filtros", ["SNCupomFiscalEle"], this.GXValidFnc[49], "AV28filtros");
   this.InitStandaloneVars( );
});
gx.setParentObj(new hmodaltipomovimentoosxsaida());
